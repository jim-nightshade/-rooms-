...
class Map:
    ...
    def room_generator(self):
        ...
        room generator
        _______________________________________________
        randomly generates rooms with stuff
        generated by stuff_generator method

        by default method generates 6 rooms

        method returns list of room objects
        each having two attributes:
        1.room number
        2.list of stuff in a given room
        '''
        room_list = []
        for i in range(6):
